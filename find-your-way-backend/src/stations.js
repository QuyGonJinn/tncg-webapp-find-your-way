...
// Photo upload stations (Bibelpose, Heilige Buchstabenjagd, Anchor of Hope) have no default code - admin enters code when confirming
const STATIONS = [
  ...
  { id: 5,  title: "Anchor of Hope",          type: "passiv", points: 50, emoji: "⚓", code: null },
  { id: 6,  title: "Krüge von Kana",          type: "aktiv",  points: 50, emoji: "🏺", code: null },
  { id: 7,  title: "Die versteckte Botschaft", type: "passiv", points: 20, emoji: "🃏", code: "LK63" },
  { id: 8,  title: "Heilige Buchstabenjagd",  type: "passiv", points: 50, emoji: "📜", code: null },
  ...
  { id: 11, title: "Bibelpose",               type: "passiv", points: 50, emoji: "🎭", code: null },
  { id: 12, title: "Wort des Glaubens",       type: "passiv", points: 20, emoji: "🐝", code: null },
];
