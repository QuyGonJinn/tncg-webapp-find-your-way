        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          {tab === 'new' ? (
            <form onSubmit={handleCreate}>
              <label className="block text-amber-900 font-bold mb-2 text-lg">Teamname</label>
              <input
                type="text"
                value={name}
              ...
              <label className="block text-amber-900 font-bold mb-3 text-lg">Team-Icon wählen</label>
              ...
              <div className="bg-amber-100 border-2 border-amber-300 rounded-2xl p-4 mb-6">
                <p className="text-amber-900 font-bold text-sm">ℹ️ Anmeldung</p>
            ...
            <form onSubmit={handleLogin}>
              ...
              <label className="block text-amber-900 font-bold mb-2 text-lg">Team-Code</label>
              <input
                type="text"
                value={pin}
