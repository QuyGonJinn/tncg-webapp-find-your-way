...
export const STATIONS_DATA = [
  ...
  { id: 5,  titleKey: "stations.anchorOfHope.title",            descriptionKey: "stations.anchorOfHope.description", type: "passiv", points: 50, emoji: "⚓", code: null, instructionsKey: "stations.anchorOfHope.instructions" },
  ...
  { id: 8,  titleKey: "stations.heiligeBuchstabenjagd.title",   descriptionKey: "stations.heiligeBuchstabenjagd.description", type: "passiv", points: 50, emoji: "📜", code: null, instructionsKey: "stations.heiligeBuchstabenjagd.instructions" },
  ...
  { id: 11, titleKey: "stations.bibelpose.title",               descriptionKey: "stations.bibelpose.description", type: "passiv", points: 50, emoji: "🎭", code: null, instructionsKey: "stations.bibelpose.instructions" },
  { id: 12, titleKey: "stations.wortDesGlaubens.title",         descriptionKey: "stations.wortDesGlaubens.description", type: "passiv", points: 20, emoji: "🐝", code: null, instructionsKey: "stations.wortDesGlaubens.instructions" },
];
